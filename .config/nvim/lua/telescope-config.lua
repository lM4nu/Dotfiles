...
vim.keymap.set('n', '<leader>gf',
  function() require('telescope.builtin').live_grep({ glob_pattern = "!node_modules" }) end,
...
vim.keymap.set('n', '<leader>sgp', ':FindGlomoPage<cr>', { desc = '[S]earch [G]lomo [P]ages' })
